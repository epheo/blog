...
* :doc:`Podman </notes/podman>` - Notes on Podman container technology
* :doc:`Linux File Permissions and ACLs </notes/linux/droits-multiples-et-acl/index>` - Managing multiple permissions and ACLs in Linux
